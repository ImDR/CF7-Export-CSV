			...
			if(!empty($allForms)){
				...
				<tr id="<?php echo esc_attr($postId); ?>">
					...
					<td>
						<?php if($record_count){ ?>
							<form method="post">
								<input type="hidden" name="downloadFormId" value="<?php echo esc_attr($postId); ?>"/>
								<input type="hidden" name="downloadFormName" value="<?php echo esc_attr($postTitle); ?>"/>
					...
					<td>
						<?php if($record_count){ ?>
							<form method="post" onsubmit="return deleteConfirm();">
								<input type="hidden"  name="deleteFormId" value="<?php echo esc_attr($postId); ?>"/>
					...
					<form method="post">
						...
						<input type='hidden' name='action' value='<?php echo (in_array($postId,$cf7Id))?'off':'on'; ?>'/>
